...
| P3-WINDOWS-EOL-001 | recorded limitation | The Windows checkout has `core.autocrlf=true`, so raw hashing of `tools/build-single-file.sh` differs from the P3 LF manifest despite a clean Git index. | P3 gate is verified from a disposable LF audit clone; P6 does not alter P3 validation policy. |
| P4-ARCH-001 | blocked | Same-page local-launcher takeover stalls after `callMain`; P4 is not a usable runtime base. | External `SFHS-DOOM-P4-BLOCKED` bundle hashes verified by P6-000; do not merge or reuse P4 runtime work. |
| P6-ANDROID-HEAP-001 | resolved | The first P6 candidate aborted because `HEAP32` was omitted from the runtime-method export list. | User-authorized P6-040 amendment added only `HEAP32`; rebuilt candidate SHA-256 `fb357e4276a019832a30ba0719a26b5ad815c7accb45ff46be8b302c7406c171` passes direct-file runtime proof. |
